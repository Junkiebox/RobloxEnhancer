...
Storage.Get("youtube",function(v){$(".youtube").prop("checked",v.youtube);if(v.youtube==true){$(".youtube").parent().addClass("GreenBackground");}else{$(".youtube").parent().removeClass("GreenBackground");}});
Storage.Get("decal",function(v){$(".decal").prop("checked",v.decal);if(v.decal==true){$(".decal").parent().addClass("GreenBackground");}else{$(".decal").parent().removeClass("GreenBackground");}});
Storage.Get("archive",function(v){$(".archive").prop("checked",v.archive);if(v.archive==true){$(".archive").parent().addClass("GreenBackground");}else{$(".archive").parent().removeClass("GreenBackground");}});
Storage.Get("profile",function(v){$(".profile").prop("checked",v.profile);if(v.profile==true){$(".profile").parent().addClass("GreenBackground");}else{$(".profile").parent().removeClass("GreenBackground");}});
Storage.Get("games",function(v){$(".games").prop("checked",v.games);if(v.games==true){$(".games").parent().addClass("GreenBackground");}else{$(".games").parent().removeClass("GreenBackground");}});
Storage.Get("obc",function(v){$(".obc").prop("checked",v.obc);if(v.obc==true){$(".obc").parent().addClass("GreenBackground");}else{$(".obc").parent().removeClass("GreenBackground");}});
Storage.Get("forum",function(v){$(".forum").prop("checked",v.forum);if(v.forum==true){$(".forum").parent().addClass("GreenBackground");}else{$(".forum").parent().removeClass("GreenBackground");}});
Storage.Get("background",function(v){$(".background").prop("checked",v.background);if(v.background==true){$(".background").parent().addClass("GreenBackground");}else{$(".background").parent().removeClass("GreenBackground");}});
Storage.Get("protection",function(v){$(".protection").prop("checked",v.protection);if(v.protection==true){$(".protection").parent().addClass("GreenBackground");}else{$(".protection").parent().removeClass("GreenBackground");}});
Storage.Get("advert",function(v){$(".advert").prop("checked",v.advert);if(v.advert==true){$(".advert").parent().addClass("GreenBackground");}else{$(".advert").parent().removeClass("GreenBackground");}});
Storage.Get("Status",function(v){$(".Status").prop("checked",v.Status);if(v.Status==true){$(".Status").parent().addClass("GreenBackground");}else{$(".Status").parent().removeClass("GreenBackground");}});
