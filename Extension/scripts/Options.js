...
$(".TrackThread").on("click",function(){chrome.storage.sync.set({TrackThread:$(".TrackThread").prop("checked")});});
...
chrome.storage.sync.get("TrackThread",function(v){$(".TrackThread").prop("checked",v.TrackThread);if(v.TrackThread==true){$(".TrackThread").parent().addClass("GreenBackground");}else{$(".TrackThread").parent().removeClass("GreenBackground");}});
